<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="container mx-auto max-w-full bg-gray-800">
            <!-- Name -->
            <div class="mt-4">
                <div class="flex items-center mb-2">
                    <svg class="w-6 h-6 text-gray-500 dark:text-gray-500 mr-2" fill="#FF3737" stroke="black"
            ...
            <div class="mt-4">
                ...
                <x-text-input id="documento" class="block mt-1 w-full border-1 border-gray-400 bg-white dark:bg-white-dark dark:placeholder-black text-black dark:text-black"
            ...
            <div class="mt-6">
                ...
                <x-text-input id="telefono" class="block mt-1 w-full border-1 border-gray-400 bg-white dark:bg-white-dark dark:placeholder-black text-black dark:text-black" type="text"
                    name="telefono" :value="old('telefono')" required autofocus autocomplete="telefono"
                    placeholder="Ingrese el número de su celular" style="background-color: white;" />
            ...
            <div class="mt-6">
                ...
                <x-text-input id="fecha_ingreso" class="block mt-1 w-full border-1 border-gray-400 bg-white dark:bg-white-dark dark:placeholder-black text-black dark:text-black"
            ...
            <div class="mt-6 mb-2">
                ...
                <x-text-input id="email" class="block mt-1 w-full border-1 border-gray-400 bg-white dark:bg-white-dark dark:placeholder-black text-black dark:text-black"
