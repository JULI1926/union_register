    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            <div class="flex items-center mb-2">
                <svg class="w-6 h-6 text-gray-500 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
        ...
        <div class="mt-4 mb-2">
            <div class="flex items-center mb-2">
                <svg class="w-6 h-6 text-gray-500 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
