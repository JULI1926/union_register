    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            <div class="flex items-center mb-2">
                <svg class="w-6 h-6 text-gray-500 mr-2" fill="#FF3737" stroke="black" stroke-width="2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
            ...
            <x-text-input id="name" class="block mt-1 w-full border-1 border-gray-400" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" placeholder="Ingrese su nombre" />
        ...
        <div class="mt-4">
            <div class="flex items-center mb-2">
                ...
                <x-input-label for="lastname" :value="__('Ingrese sus apellidos')" />
            </div>

            <x-text-input id="lastname" class="block mt-1 w-full border-1 border-gray-400" type="text" name="lastname" :value="old('lastname')" required autofocus autocomplete="lastname" placeholder="Ingrese su nombre completo" />
        ...
        <div class="mt-6">
            <div class="flex items-center mb-2">
                <svg class="w-6 h-6 text-gray-500 mr-2" fill="#FF3737" stroke="black" stroke-width="10" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
        ...
        <div class="mt-6">
            <div class="flex items-center mb-2">
                <svg class="w-6 h-6 text-gray-500 mr-2" fill="#FF3737" stroke="black" stroke-width="10" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
        ...
        <div class="mt-6 mb-2">
            ...
            <select id="departamento" name="departamento" class="block mt-1 w-full border-gray-400 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>
        ...
        <div class="mt-6 mb-2">
            ...
            <select id="municipio" name="municipio" class="block mt-1 w-full border-gray-400 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>
        ...
        <div class="mt-6">
            <div class="flex items-center mb-2">
                <svg class="w-6 h-6 text-gray-500 mr-2" fill="#FF3737" stroke="black" stroke-width="10" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
            ...
            <select id="cargo" name="cargo" class="block mt-1 w-full border-gray-400 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>
